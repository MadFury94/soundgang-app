// =============================================================================
// Admin API Client
// Reads token from localStorage. Sends Authorization: Bearer <token>.
// On 401, redirects to /admin/login.
// =============================================================================

const API_URL = import.meta.env.VITE_API_URL ?? 'https://soundgang-api.onochieazukaeme.workers.dev';
